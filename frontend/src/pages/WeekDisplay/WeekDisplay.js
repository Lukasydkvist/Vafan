...
function DispMeeting() {
	...
	useEffect(() => {
		fetch(resolveUrl("/api/meet/meetingList"),{ //if i put the function call here i get error i the code :(
	...
	const meetingList = () => {
		fetch(resolveUrl("/api/meet/meetingList"),{
			method: "POST",
			headers: {
				"Content-Type": "application/json",
				Authorization: `Bearer ${token}`
	...
	const getYoureMeetingList = () => {
		fetch(resolveUrl("/api/meet/YoureMeetingList"),{
			method: "POST",
			headers: {
				"Content-Type": "application/json",
				Authorization: `Bearer ${token}`
	...
	const deleteMeeting = (id) => {
		fetch(resolveUrl("/api/meet/DeleteMeeting"), {
			method: "POST",
			headers: {
				"Content-Type": "application/json",
				Authorization: `Bearer ${token}`
